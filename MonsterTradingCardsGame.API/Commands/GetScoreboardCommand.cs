...
{
    internal class GetScoreboardCommand : IRequestCommand
    {
        private readonly IGameService _gameService;
        private readonly ITokenService _tokenService;

        public GetScoreboardCommand(IGameService gameService, ITokenService tokenService)
        {
        ...
        public HttpResponse Execute(HttpRequest request)
        {
            ...
            try
            {
                ...
                response.Payload = System.Text.Json.JsonSerializer.Serialize(scoreboard);
